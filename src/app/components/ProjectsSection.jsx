...
const projectsData = [
    {
        id: 1,
        title: "Jogo da memória -  JavaScript Vanilla",
        description: "Jogo da memória",
        image: "/images/projects/memoryGame.png",
        tag: ["Todos"],
        previewUrl: "https://lauraxavier.github.io/memoryGame/",
        gitUrl: "https://github.com/lauraxavier/memoryGame",
    },
    {
        id: 2,
...
const ProjectsSection = () => {
    ...
    return (
        ...
        >
            <h2 className="text-center  dark:text-white text-4xl font-bold mt-4 mb-14 md:mb-12">
                Meus Projetos
            </h2>
            <div className="dark:text-white flex flex-row justify-center items-center gap-2 py-6 mb-3">
                <ProjectTag
