  ...
  return (
    <section className="min-h-screen mb-[150px] flex justify-center items-center">
      <div className="grid grid-cols-1 sm:grid-cols-12 min-h-[510px]">
        ...
        >
          <h1 className="text-white mb-2 min-h-[270px] lg:min-h-[350px] text-[35px] sm:text-[50px] md:text-[40px] lg:text-[60px] lg:leading-normal font-extrabold">
        ...
        >
          ...
          <div className="mb-3 lg:mb-0 justify-center items-center flex flex-col md:flex-row md:items-baseline lg:gap-4">
            <motion.a
